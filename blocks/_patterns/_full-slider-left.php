...
return array(
    'title'       => 'Full slider left',
    'description' => 'Columns block with wide text and full slider on the left',
    'categories'  =>  array( 'blank' ),
    'content'     => '<!-- wp:columns {"verticalAlignment":"center","align":"full","style":{"spacing":{"margin":{"bottom":"10vh"}}},"className":"full-slider"} -->
    <div class="wp-block-columns alignfull are-vertically-aligned-center full-slider" style="margin-bottom:10vh"><!-- wp:column {"verticalAlignment":"center"} -->
    ...
    <!-- wp:column {"verticalAlignment":"center","className":"wp-column-text wide-text"} -->
    ...
    <h3 class="wp-block-heading"><strong><sup>Custom slider text</sup></strong><br><strong>Text on the right</strong></h3>
    <!-- /wp:heading -->
