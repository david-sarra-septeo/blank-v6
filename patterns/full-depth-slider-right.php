<?php
/**
 * Title: Full depth slider right
 * Slug: blank-theme/full-depth-slider-right
 * Categories: blank
 */ 
?>
<!-- wp:columns {"verticalAlignment":"center","align":"full","style":{"spacing":{"margin":{"bottom":"10vh"}}},"className":"full-slider has-slider-on-the-right"} -->
